      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded border border-edge px-2 py-0.5 font-mono text-xs text-zinc-400 hover:border-lime-500/40 hover:text-lime-300"
            title="Jump to today"
          >
            Today →
          </button>
...
function TrackTick(props: {
  ...
  return (
    <span className="flex h-3.5 w-3.5 items-center justify-center rounded-sm border border-edge-strong font-mono text-[8px] text-zinc-700">
      {props.letter}
    </span>
  )
}
