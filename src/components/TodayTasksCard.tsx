...
export function TodayTasksCard() {
  ...
  return (
    <section className="surface-glossy rounded-xl p-4 md:p-5">
      ...
      <div className="mt-3 flex gap-1 rounded-md border border-[#3d4150] bg-[#1c1f27] p-1 text-xs">
            ...
            <button
              ...
              className={cn(
                ...
                active
                  ...
                  : 'text-zinc-300 hover:bg-[#262934] hover:text-zinc-100',
              )}
              aria-pressed={active}
            >
      ...
      <ul className="mt-3 divide-y divide-[#3d4150]/60">
        {visible.length === 0 ? (
